module.exports = {
  extends: ['eslint-config-airbnb', 'plugin:prettier/recommended', 'plugin:storybook/recommended'],
  ...
  rules: {
    ...
    // https://github.com/airbnb/javascript/commit/788208295469e19b806c06e01095dc8ba1b6cdc9
  ...
  // typescript common config
  {
    ...
    plugins: ['@typescript-eslint', 'eslint-plugin-import', 'eslint-plugin-react'],
    rules: {
