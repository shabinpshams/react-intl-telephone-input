...
describe('TelInput', function() {
  beforeEach(() => {
    ...
    this.makeSubject = () => {
      return mount(<IntlTelephoneInput {...this.params} />, {
  ...
  it('onPhoneNumberChange without libphonenumber', () => {
    ...
    window.intlTelephoneInputUtils = undefined
  ...
  it('should not focused on render', () => {
    const initialSelectFlag = IntlTelephoneInput.prototype.selectFlag

    let focused = false

    IntlTelephoneInput.prototype.selectFlag = function selectFlag(
      countryCode,
      setFocus = true,
    ) {
    ...
    IntlTelephoneInput.prototype.selectFlag = initialSelectFlag
  ...
  it('utils loaded', () => {
    ...
    expect(typeof window.intlTelephoneInputUtils === 'object')
    expect(typeof window.intlTelephoneInputUtils.isValidNumber === 'function')
  })
