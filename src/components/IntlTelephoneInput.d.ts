...
export interface IntlTelephoneInputProps {
  /**
...
export interface IntlTelephoneInputState {
...
export default class IntlTelephoneInput extends React.Component<
  IntlTelephoneInputProps,
  IntlTelephoneInputState
> {
  //#region Properties
  wrapperClass: {
    [key: string]: boolean
   ...
   */
  updatePlaceholder(props?: IntlTelephoneInputProps): void
